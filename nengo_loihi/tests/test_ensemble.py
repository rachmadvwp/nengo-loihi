...
def test_amplitude(Simulator, amplitude, seed, allclose):
    ...
    # other reasons, see
    # https://gl.appliedbrainresearch.com/abr/nengo-loihi/issues/26
    ...
    # note: one-timestep delay, despite synapse=None; see
    # https://gl.appliedbrainresearch.com/abr/nengo-loihi/issues/28
